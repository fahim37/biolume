  ...
  const projects = [
    {
      ...
      query:
        "aerial view of W Hotel Yas Island Abu Dhabi at night with purple lighting",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      query:
        "Wynn Al Marjan Island Ras Al Khaimah resort aerial view at sunset",
    },
    {
      id: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 ">
        ...
        >
          <p className="text-sm md:text-[24px] text-[#272727] leading-[120%] font-normal mx-auto mb-[100px]">
            These are some of the featured projects were led by our founder
            during her previous roles in the lighting and construction industry
            across Middle East that reflect the level of care, expertise, and
            resolution we now guide every brand engagement.
          </p>
          <motion.h2
        ...
        >
          {(projectsData.length > 0 ? projectsData : projects).map(
            (project) => (
              <motion.div
                key={project.id}
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-20">
                  <motion.h3
                    className="text-xl md:text-2xl font-semibold text-center text-[#FFFFFF]"
