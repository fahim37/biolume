    ...
    <div className="bg-[#E5F4F9]">
      ...
      <section className="bg-[#E5F4F9] py-8 md:py-16">
        <div className="container mx-auto px-4">
          {/* Section Header */}
          <div className="text-center mb-8 md:mb-12 p-4 md:p-6 shadow-[0_2px_10px_rgba(0,0,0,0.1)] rounded-lg">
          ...
          {/* Feature Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-[100px]">
            {/* Experience & Expertise */}
            <div className="text-center shadow-[0_2px_10px_rgba(0,0,0,0.1)] p-4 md:p-6 space-y-3 md:space-y-4 rounded-lg bg-[#E5F4F9]">
            ...
            {/* Client-Focused */}
            <div className="text-center shadow-[0_2px_10px_rgba(0,0,0,0.1)] p-4 md:p-6 space-y-3 md:space-y-4 rounded-lg bg-[#E5F4F9] md:col-span-2 xl:col-span-1 md:max-w-md md:mx-auto xl:max-w-none">
              <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-44 md:h-44 mx-auto rounded-lg flex items-center justify-center overflow-hidden">
                <Image
